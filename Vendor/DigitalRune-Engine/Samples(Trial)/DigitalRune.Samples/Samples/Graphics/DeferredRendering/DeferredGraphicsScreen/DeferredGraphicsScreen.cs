...
namespace DigitalRune.Samples
{
  ...
  class DeferredGraphicsScreen : GraphicsScreen, IDisposable
  {
    ...
    protected void RenderScene(CustomSceneQuery sceneQuery, RenderContext context, 
      bool doPostProcessing, bool renderLensFlares, bool renderDebugOutput, bool renderReticle)
    {
      ...
      else
      {
        ...
        SpriteBatch.Draw(context.SourceTexture, new Rectangle(0, 0, viewport.Width, viewport.Height), Color.White);
        SpriteBatch.End();
      }
